...
export function FAQSection() {
  const faqs = [
    {
      question: 'Is Nexus Forge AI only for government agencies?',
      answer: 'No! While Nexus Forge AI is suitable for government use, it is designed for all types of companies—from startups and small businesses to large enterprises across every industry. Our AI capabilities are flexible and adapt to your organization\'s specific needs, regardless of sector.',
    },
    {
    ...
    {
      question: 'Do I need technical expertise to use Nexus Forge AI?',
      answer: 'No technical expertise is required to test and use Nexus Forge AI. Our interface is designed to be intuitive for business users. However, technical teams can also integrate Nexus Forge AI into existing workflows and systems. We provide documentation and support for both business users and technical implementers.',
    },
    {
    ...
    {
      question: 'Can Nexus Forge AI integrate with our existing systems?',
      answer: 'Yes, Nexus Forge AI is designed with integration in mind. We support standard APIs and can work with your technical team to integrate with existing workflows, databases, and business systems. Specific integration capabilities depend on your requirements and deployment model.',
    },
    {
      question: 'What kind of support do you provide?',
      answer: 'We provide comprehensive support including documentation, email support, and dedicated account management for enterprise customers. Support levels vary by plan. During evaluation, our team is available to answer questions and help you understand how Nexus Forge AI can meet your needs.',
    },
    {
      question: 'How accurate are the AI capabilities?',
      answer: 'AI accuracy varies by task type and input quality. Our models are trained on diverse, high-quality data and regularly evaluated. However, like all AI systems, Nexus Forge AI is not perfect and should be used as a tool to augment human decision-making, not replace it. We recommend human review of AI outputs, especially for critical decisions.',
    },
    {
      question: 'Can we customize Nexus Forge AI for our specific needs?',
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground">
              Common questions about Nexus Forge AI, our capabilities, and how we work with companies.
            </p>
          </div>
